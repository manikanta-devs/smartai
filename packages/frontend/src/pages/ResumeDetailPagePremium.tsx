...
export function ResumeDetailPagePremium() {
  ...
  const [activeTab, setActiveTab] = useState<'ai' | 'premium' | 'jobs' | 'rewrite'>('ai');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a0e1a] via-[#0f1419] to-[#111827]">
      {/* Animated Background */}
            ...
            <div className="space-y-3">
              {suggestions.map((suggestion: string, idx: number) => (
                ...
                >
                  ...
                  <button className="text-orange-500 hover:text-orange-400 text-sm font-semibold whitespace-nowrap ml-4 transition">
                    Fix This →
                  </button>
                </div>
              ))}
        ...
        <div className="glass-dark rounded-2xl p-8 border border-gray-700/50 animate-slide-up" style={{ animationDelay: '600ms' }}>
          ...
          <div className="flex gap-1 mb-8 border-b border-gray-700">
            {[
              ...
              { id: 'premium', label: 'Premium Analysis', icon: Sparkles },
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pt-4">
                ...
                >
                  ...
                  {processingAction === 'ats' ? 'Analyzing...' : 'ATS Score'}
                </button>
                <button
                  disabled={processingAction !== null}
                ...
                >
                  ...
                  {processingAction === 'match' ? 'Analyzing...' : 'Match Score'}
                </button>
                <button
                  disabled={processingAction !== null}
                ...
                >
                  ...
                  {processingAction === 'roles' ? 'Predicting...' : 'Role Prediction'}
                </button>
              </div>
            </div>
          )}
          ...
          {activeTab === 'premium' && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-400 mb-4">Premium analysis tools coming soon</p>
              <p className="text-sm text-gray-500">Enhanced ATS scoring and job matching automation</p>
            </div>
          )}
          ...
          {activeTab === 'jobs' && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-400 mb-4">Job matching engine loading</p>
              <p className="text-sm text-gray-500">Intelligent role recommendations based on your resume</p>
            </div>
          )}
          ...
          {activeTab === 'rewrite' && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-400 mb-4">AI rewrite suggestions</p>
              <p className="text-sm text-gray-500">Get actionable recommendations to improve your resume</p>
            </div>
          )}
        </div>
      </div>
